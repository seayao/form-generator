  ...
  <div v-if="show">
    <el-form label-position="top">
      ...
      <el-form-item v-if="Object.keys(data.options).indexOf('defaultValue') >= 0 && (data.type === 'textarea' || data.type === 'input' || data.type === 'rate' || data.type === 'color' || data.type === 'switch')" label="默认值">
        ...
        <el-rate v-if="data.type === 'rate'" :max="data.options.max" :allow-half="data.options.allowHalf" v-model="data.options.defaultValue" style="display:inline-block;vertical-align: middle;" />
