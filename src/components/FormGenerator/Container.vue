<template>
  <el-container>
    ...
    <cus-dialog
      ...
      <generate-form v-if="previewVisible" ref="generateForm" :data="widgetForm" :remote="remoteFuncs" :value="widgetModels">
...
@import "~@/styles/form-generator.scss";

.widget-empty{
  background: url('../../assets/form_generator/form_empty.png') no-repeat;
